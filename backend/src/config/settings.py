...
# AI / Summary provider
KNOWLEDGE_NOTE_PROVIDER = os.getenv("KNOWLEDGE_NOTE_PROVIDER", "openai_compatible")
SUBSTANCE_GATE_PROVIDER = os.getenv("SUBSTANCE_GATE_PROVIDER", "openai_compatible")
SUBSTANCE_GATE_THRESHOLD = int(os.getenv("SUBSTANCE_GATE_THRESHOLD", "6"))
PRINCIPLE_LINK_THRESHOLD = float(os.getenv("PRINCIPLE_LINK_THRESHOLD", "0.85"))
